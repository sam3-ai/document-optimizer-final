          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            {isAuthenticated ? (
              ...
              <>
                ...
                <Link
                  href="/signup"
                  className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-2 rounded-xl font-medium hover:shadow-lg transition-all duration-200 transform hover:scale-105"
                >
                  Sign Up
                </Link>
              </>
