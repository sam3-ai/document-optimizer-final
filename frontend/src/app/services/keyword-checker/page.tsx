...
export default function KeywordChecker() {
  ...
  const getRecommendations = (keywordAnalysis: KeywordItem[]) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <h1 className="text-4xl font-extrabold text-gray-900 sm:text-5xl">
            Keyword Density <span className="text-orange-600">Checker</span>
          </h1>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6">
              ...
              <div className="mt-4 flex justify-between items-center">
                ...
                <button
                  ...
                  className="px-6 py-2 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-lg font-medium hover:from-orange-600 hover:to-red-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
                >
            ...
            {analysis ? (
                      ...
                      {analysis.keywordAnalysis.map((item, index) => (
                        <div key={index} className={`p-3 rounded-lg ${getStatusBg(item.status)}`}>
                          <div className="flex justify-between items-center">
                            ...
                            <span className={`font-semibold ${getStatusColor(item.status)}`}>{item.density}%</span>
                          </div>
                    ...
                    {analysis.topWords.map((item, index) => (
                      ...
                      >
                        ...
                        <div className="text-right">
                          <span className="text-orange-600 font-semibold">{item.density}%</span>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <p className="text-gray-500 italic">
                  Enter your content and target keywords, then click &quot;Analyze Keywords&quot; to see detailed
