...
export default function ReadabilityAnalyzer() {
  ...
  const getSuggestions = (score: number, avgWords: number) => {
    const suggestions = [];
    if (score < 60) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-green-500 to-green-700 rounded-full mb-6">
          ...
          <h1 className="text-4xl font-extrabold text-gray-900 sm:text-5xl">
            Readability <span className="text-green-600">Analyzer</span>
          </h1>
        ...
        <div className="mt-12 grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 bg-white rounded-xl shadow-lg p-6">
            ...
            <textarea
              ...
              className="w-full h-80 p-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent resize-none"
            />
            <div className="mt-4 flex justify-between items-center">
              ...
              <button
                ...
                className="px-6 py-2 bg-gradient-to-r from-green-500 to-green-700 text-white rounded-lg font-medium hover:from-green-600 hover:to-green-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
              >
            ...
            {analysis ? (
              <>
                ...
                <div className="bg-white rounded-xl shadow-lg p-6">
                  ...
                  <div className={`text-center p-6 rounded-lg ${getScoreBg(analysis.readabilityScore)}`}>
                    ...
                    <div className="text-sm text-gray-600 mt-2">{analysis.grade}</div>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <p className="text-gray-500 italic">
                  Enter text and click &quot;Analyze Text&quot; to see readability metrics and suggestions.
                </p>
              </div>
            )}
          </div>
