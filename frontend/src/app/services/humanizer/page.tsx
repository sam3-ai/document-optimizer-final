...
import { FaRobot, FaUser, FaSpinner, FaCopy, FaDownload, FaMagic, FaCheckCircle } from 'react-icons/fa';
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-100 py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">AI Text Humanizer 🤖➡️👤</h1>
        ...
        >
          <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">Why Use Our AI Humanizer? 🌟</h3>
