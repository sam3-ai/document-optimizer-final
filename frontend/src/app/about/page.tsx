...
const team = [
  { name: 'Alex Johnson', role: 'CEO & Founder', image: 'A' },
  { name: 'Sarah Williams', role: 'CTO', image: 'S' },
  { name: 'Michael Chen', role: 'Lead Developer', image: 'M' },
  { name: 'Emily Davis', role: 'Product Manager', image: 'E' },
];
